(function (root) {
  ...
  const translations = {
    "zh-TW": {
      ...
      "filters.heading": "篩選條件", "common.clear": "清除", "common.close": "關閉", "common.cancel": "取消", "common.remove": "移除 {label}",
	  "edit.open": "編輯資料", "edit.photoTitle": "編輯照片資料", "edit.mediaTitle": "編輯影音資料", "edit.title": "標題", "edit.project": "專題", "edit.date": "日期與時間", "edit.tags": "Tags（逗號分隔）", "edit.description": "說明", "edit.copyright": "Copyright", "edit.locationName": "地點名稱", "edit.rating": "評分", "edit.favorite": "加入精選", "edit.clearLocation": "清除 GeoTag", "edit.customMetadata": "自訂 Metadata（JSON）", "edit.save": "儲存修改", "edit.failed": "無法儲存修改", "edit.invalidJSON": "自訂 Metadata 必須是有效的 JSON",
	  "relations.heading": "關聯資料", "relations.projects": "Projects", "relations.stories": "Stories", "relations.projectStories": "此 Project 關聯的 Stories", "relations.parents": "來源照片", "relations.children": "衍生照片", "relations.relatedMedia": "相關影音素材", "relations.parentsInput": "來源照片（每行：Photo ID | 關係類型）", "relations.childrenInput": "衍生照片（每行：Photo ID | 關係類型）", "relations.relatedMediaInput": "相關素材（每行一個 Audio/Video ID）", "relations.newProjectPlaceholder": "新增 Project description", "relations.newStoryPlaceholder": "新增 Story description", "relations.add": "新增", "relations.description": "Description", "relations.descriptionRequired": "Description 不可空白", "relations.none": "尚無關聯", "relations.noneAvailable": "尚無可選項目", "relations.unavailable": "關聯資料暫時無法使用",
	  "bulkRelations.selectVisible": "勾選目前顯示", "bulkRelations.selectSearch": "勾選全部搜尋結果", "bulkRelations.selected": "已選擇 {count} 筆", "bulkRelations.selectItem": "勾選 {title}", "bulkRelations.selecting": "正在取得搜尋結果…", "bulkRelations.limit": "搜尋結果超過上限，已勾選前 {count} 筆", "bulkRelations.clear": "清除勾選", "bulkRelations.open": "批次修改關聯", "bulkRelations.title": "批次修改關聯", "bulkRelations.summary": "將修改 {count} 筆{media}；整批會一起成功或一起取消。", "bulkRelations.operation": "操作方式", "bulkRelations.add": "新增關聯", "bulkRelations.remove": "移除關聯", "bulkRelations.replace": "取代全部關聯", "bulkRelations.photoRelation": "Photo parent／child", "bulkRelations.direction": "勾選照片是", "bulkRelations.childrenOf": "指定 Parent 的 children", "bulkRelations.parentsOf": "指定 Child 的 parents", "bulkRelations.otherPhoto": "另一端 Photo ID", "bulkRelations.relationType": "關係類型", "bulkRelations.apply": "套用到已選項目", "bulkRelations.chooseType": "請至少勾選一種要修改的關聯", "bulkRelations.photoRequired": "請輸入另一端 Photo ID", "bulkRelations.saving": "正在套用整批修改…", "bulkRelations.saved": "已更新 {count} 筆", "bulkRelations.failed": "批次關聯修改失敗",
      "deepAnalysis.action": "使用大型語言深度分析", "deepAnalysis.rerun": "重新使用大型語言深度分析", "deepAnalysis.heading": "照片內容分析", "deepAnalysis.note": "分析結果只會作為建議，不會改動人工輸入的資料。", "deepAnalysis.queueing": "正在建立深度分析工作…", "deepAnalysis.queued": "已將 {count} 張照片加入深度分析佇列", "deepAnalysis.alreadyCurrent": "所選照片已有最新分析結果", "deepAnalysis.progress": "深度分析處理中：{processed} / {total}", "deepAnalysis.completed": "深度分析完成：{count} 張", "deepAnalysis.partial": "深度分析完成：成功 {success} 張，失敗 {failed} 張", "deepAnalysis.failed": "深度分析失敗；請確認 server 上的模型服務", "deepAnalysis.cancelled": "深度分析工作已停止", "deepAnalysis.unavailable": "深度分析資料暫時無法使用", "deepAnalysis.visibleText": "畫面文字：", "deepAnalysis.status.not_requested": "尚未進行深度分析", "deepAnalysis.status.pending": "等待深度分析", "deepAnalysis.status.running": "正在進行深度分析…", "deepAnalysis.status.completed": "深度分析已完成", "deepAnalysis.status.failed": "上次深度分析失敗，可以重新執行",
      ...
      "llm.title": "大型語言模型", "llm.active": "已啟用 (Qwen2-VL)", "llm.deactive": "已停用 (已釋放記憶體)", "llm.switching": "切換中…", "llm.tooltip": "點擊切換大型語言模型狀態（停用可釋放記憶體）", "llm.deactivatedNote": "大型語言模型目前為停用狀態，請先在右上角啟用",
      ...
      "field.sampleRate": "取樣率", "field.channels": "聲道", "field.originalStatus": "原檔狀態", "field.thumbnailStatus": "縮圖狀態", "field.previewStatus": "預覽圖狀態", "field.path": "檔案路徑", "field.duplicatePaths": "重複檔案路徑",
    ...
    en: {
      ...
      "filters.heading": "Filters", "common.clear": "Clear", "common.close": "Close", "common.cancel": "Cancel", "common.remove": "Remove {label}", "filters.project": "Project", "filters.tags": "Tags",
	  "edit.open": "Edit metadata", "edit.photoTitle": "Edit photo metadata", "edit.mediaTitle": "Edit media metadata", "edit.title": "Title", "edit.project": "Project", "edit.date": "Date and time", "edit.tags": "Tags (comma separated)", "edit.description": "Description", "edit.copyright": "Copyright", "edit.locationName": "Location name", "edit.rating": "Rating", "edit.favorite": "Add to featured", "edit.clearLocation": "Clear GeoTag", "edit.customMetadata": "Custom metadata (JSON)", "edit.save": "Save changes", "edit.failed": "Could not save changes", "edit.invalidJSON": "Custom metadata must be valid JSON",
	  "relations.heading": "Relationships", "relations.projects": "Projects", "relations.stories": "Stories", "relations.projectStories": "Stories linked to this project", "relations.parents": "Source photos", "relations.children": "Derived photos", "relations.relatedMedia": "Related media", "relations.parentsInput": "Source photos (one per line: Photo ID | relationship type)", "relations.childrenInput": "Derived photos (one per line: Photo ID | relationship type)", "relations.relatedMediaInput": "Related media (one Audio/Video ID per line)", "relations.newProjectPlaceholder": "New project description", "relations.newStoryPlaceholder": "New story description", "relations.add": "Add", "relations.description": "Description", "relations.descriptionRequired": "Description is required", "relations.none": "No relationships", "relations.noneAvailable": "No items available", "relations.unavailable": "Relationship data is unavailable",
	  "bulkRelations.selectVisible": "Select visible", "bulkRelations.selectSearch": "Select all search results", "bulkRelations.selected": "{count} selected", "bulkRelations.selectItem": "Select {title}", "bulkRelations.selecting": "Loading search results…", "bulkRelations.limit": "More results exist; the first {count} were selected", "bulkRelations.clear": "Clear selection", "bulkRelations.open": "Bulk edit relationships", "bulkRelations.title": "Bulk edit relationships", "bulkRelations.summary": "Update {count} {media}; the entire batch succeeds or rolls back together.", "bulkRelations.operation": "Operation", "bulkRelations.add": "Add relationships", "bulkRelations.remove": "Remove relationships", "bulkRelations.replace": "Replace all relationships", "bulkRelations.photoRelation": "Photo parent/child", "bulkRelations.direction": "Selected photos are", "bulkRelations.childrenOf": "children of the specified parent", "bulkRelations.parentsOf": "parents of the specified child", "bulkRelations.otherPhoto": "Other Photo ID", "bulkRelations.relationType": "Relationship type", "bulkRelations.apply": "Apply to selected items", "bulkRelations.chooseType": "Choose at least one relationship type to update", "bulkRelations.photoRequired": "Enter the other Photo ID", "bulkRelations.saving": "Applying the atomic batch…", "bulkRelations.saved": "Updated {count} items", "bulkRelations.failed": "Bulk relationship update failed",
      "deepAnalysis.action": "Use large-language deep analysis", "deepAnalysis.rerun": "Run large-language deep analysis again", "deepAnalysis.heading": "Photo content analysis", "deepAnalysis.note": "Results are suggestions only and never change human-entered data.", "deepAnalysis.queueing": "Creating deep analysis job…", "deepAnalysis.queued": "Queued {count} photos for deep analysis", "deepAnalysis.alreadyCurrent": "Selected photos already have current results", "deepAnalysis.progress": "Deep analysis in progress: {processed} / {total}", "deepAnalysis.completed": "Deep analysis completed: {count} photos", "deepAnalysis.partial": "Deep analysis completed: {success} succeeded, {failed} failed", "deepAnalysis.failed": "Deep analysis failed; check the model service on the server", "deepAnalysis.cancelled": "Deep analysis job stopped", "deepAnalysis.unavailable": "Deep analysis data is temporarily unavailable", "deepAnalysis.visibleText": "Visible text:", "deepAnalysis.status.not_requested": "Deep analysis has not been run", "deepAnalysis.status.pending": "Waiting for deep analysis", "deepAnalysis.status.running": "Deep analysis is running…", "deepAnalysis.status.completed": "Deep analysis completed", "deepAnalysis.status.failed": "The last deep analysis failed; you can run it again",
      ...
      "llm.title": "Large Language Model", "llm.active": "Active (Qwen2-VL)", "llm.deactive": "Deactivated (Memory freed)", "llm.switching": "Switching…", "llm.tooltip": "Toggle LLM state (deactivate to free memory)", "llm.deactivatedNote": "LLM is currently deactivated. Please activate it at the top right.",
      ...
      "field.duration": "Duration", "field.sampleRate": "Sample rate", "field.channels": "Channels", "field.originalStatus": "Original status", "field.thumbnailStatus": "Thumbnail status", "field.previewStatus": "Preview status", "field.path": "File path", "field.duplicatePaths": "Duplicate paths",
    ...
    de: {
      ...
      "filters.heading": "Filter", "common.clear": "Leeren", "common.close": "Schließen", "common.cancel": "Abbrechen", "common.remove": "{label} entfernen", "filters.project": "Projekt", "filters.tags": "Tags",
	  "edit.open": "Metadaten bearbeiten", "edit.photoTitle": "Fotodaten bearbeiten", "edit.mediaTitle": "Mediendaten bearbeiten", "edit.title": "Titel", "edit.project": "Projekt", "edit.date": "Datum und Uhrzeit", "edit.tags": "Tags (kommagetrennt)", "edit.description": "Beschreibung", "edit.copyright": "Copyright", "edit.locationName": "Ortsname", "edit.rating": "Bewertung", "edit.favorite": "Zu Favoriten hinzufügen", "edit.clearLocation": "GeoTag löschen", "edit.customMetadata": "Eigene Metadaten (JSON)", "edit.save": "Änderungen speichern", "edit.failed": "Änderungen konnten nicht gespeichert werden", "edit.invalidJSON": "Eigene Metadaten müssen gültiges JSON sein",
	  "relations.heading": "Beziehungen", "relations.projects": "Projekte", "relations.stories": "Stories", "relations.projectStories": "Mit diesem Projekt verknüpfte Stories", "relations.parents": "Quellfotos", "relations.children": "Abgeleitete Fotos", "relations.relatedMedia": "Verknüpfte Medien", "relations.parentsInput": "Quellfotos (eine Zeile: Foto-ID | Beziehungstyp)", "relations.childrenInput": "Abgeleitete Fotos (eine Zeile: Foto-ID | Beziehungstyp)", "relations.relatedMediaInput": "Verknüpfte Medien (eine Audio-/Video-ID pro Zeile)", "relations.newProjectPlaceholder": "Neue Projektbeschreibung", "relations.newStoryPlaceholder": "Neue Story-Beschreibung", "relations.add": "Hinzufügen", "relations.description": "Beschreibung", "relations.descriptionRequired": "Beschreibung ist erforderlich", "relations.none": "Keine Beziehungen", "relations.noneAvailable": "Keine Einträge verfügbar", "relations.unavailable": "Beziehungsdaten sind nicht verfügbar",
	  "bulkRelations.selectVisible": "Sichtbare auswählen", "bulkRelations.selectSearch": "Alle Suchergebnisse auswählen", "bulkRelations.selected": "{count} ausgewählt", "bulkRelations.selectItem": "{title} auswählen", "bulkRelations.selecting": "Suchergebnisse werden geladen…", "bulkRelations.limit": "Weitere Ergebnisse vorhanden; die ersten {count} wurden ausgewählt", "bulkRelations.clear": "Auswahl leeren", "bulkRelations.open": "Beziehungen gesammelt bearbeiten", "bulkRelations.title": "Beziehungen gesammelt bearbeiten", "bulkRelations.summary": "{count} {media} bearbeiten; der gesamte Stapel wird gemeinsam gespeichert oder zurückgesetzt.", "bulkRelations.operation": "Vorgang", "bulkRelations.add": "Beziehungen hinzufügen", "bulkRelations.remove": "Beziehungen entfernen", "bulkRelations.replace": "Alle Beziehungen ersetzen", "bulkRelations.photoRelation": "Foto Parent/Child", "bulkRelations.direction": "Ausgewählte Fotos sind", "bulkRelations.childrenOf": "Children des angegebenen Parents", "bulkRelations.parentsOf": "Parents des angegebenen Childs", "bulkRelations.otherPhoto": "Andere Foto-ID", "bulkRelations.relationType": "Beziehungstyp", "bulkRelations.apply": "Auf Auswahl anwenden", "bulkRelations.chooseType": "Mindestens einen Beziehungstyp auswählen", "bulkRelations.photoRequired": "Andere Foto-ID eingeben", "bulkRelations.saving": "Atomarer Stapel wird angewendet…", "bulkRelations.saved": "{count} Elemente aktualisiert", "bulkRelations.failed": "Stapeländerung der Beziehungen fehlgeschlagen",
      "deepAnalysis.action": "Großes Sprachmodell zur Tiefenanalyse verwenden", "deepAnalysis.rerun": "Tiefenanalyse erneut ausführen", "deepAnalysis.heading": "Analyse des Fotoinhalts", "deepAnalysis.note": "Die Ergebnisse sind nur Vorschläge und ändern keine manuell eingegebenen Daten.", "deepAnalysis.queueing": "Tiefenanalyse-Auftrag wird erstellt…", "deepAnalysis.queued": "{count} Fotos zur Tiefenanalyse eingereiht", "deepAnalysis.alreadyCurrent": "Die ausgewählten Fotos haben bereits aktuelle Ergebnisse", "deepAnalysis.progress": "Tiefenanalyse läuft: {processed} / {total}", "deepAnalysis.completed": "Tiefenanalyse abgeschlossen: {count} Fotos", "deepAnalysis.partial": "Tiefenanalyse abgeschlossen: {success} erfolgreich, {failed} fehlgeschlagen", "deepAnalysis.failed": "Tiefenanalyse fehlgeschlagen; Modelldienst auf dem Server prüfen", "deepAnalysis.cancelled": "Tiefenanalyse-Auftrag gestoppt", "deepAnalysis.unavailable": "Tiefenanalyse-Daten sind vorübergehend nicht verfügbar", "deepAnalysis.visibleText": "Sichtbarer Text:", "deepAnalysis.status.not_requested": "Noch keine Tiefenanalyse", "deepAnalysis.status.pending": "Wartet auf Tiefenanalyse", "deepAnalysis.status.running": "Tiefenanalyse läuft…", "deepAnalysis.status.completed": "Tiefenanalyse abgeschlossen", "deepAnalysis.status.failed": "Die letzte Tiefenanalyse ist fehlgeschlagen und kann erneut ausgeführt werden",
      ...
      "llm.title": "Großes Sprachmodell", "llm.active": "Aktiv (Qwen2-VL)", "llm.deactive": "Deaktiviert (Speicher frei)", "llm.switching": "Umschalten…", "llm.tooltip": "LLM-Status umschalten (deaktivieren, um Speicher freizugeben)", "llm.deactivatedNote": "Das Modell ist derzeit deaktiviert. Bitte oben rechts aktivieren.",
      ...
      "field.duration": "Dauer", "field.sampleRate": "Abtastrate", "field.channels": "Kanäle", "field.originalStatus": "Status des Originals", "field.thumbnailStatus": "Thumbnail-Status", "field.previewStatus": "Vorschaustatus", "field.path": "Dateipfad", "field.duplicatePaths": "Duplikatpfade",
